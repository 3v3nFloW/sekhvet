...
- (void) sekhmetInstallMenu
{
    ...
    [[sek addItemWithTitle: NSLocalizedString( @"Window Presets (WL/WW)…", nil) action: @selector(sekhmetShowWindowingPanel:) keyEquivalent: @""] setTarget: self]; // SekhVet Paket AE
